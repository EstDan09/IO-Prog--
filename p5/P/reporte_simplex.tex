...
$R_{1}$ & 1,000000 & 1,000000 & 1,000000 & 0,000000 & 6,000000 \\
$R_{2}$ & 1,000000 & 4,000000 & 0,000000 & 1,000000 & 12,000000 \\
\bottomrule
\end{tabular}
\end{table}
...
$R_{1}$ & \cellcolor{orange!35}1,000000 & \cellcolor{green!12}1,000000 & \cellcolor{green!12}1,000000 & \cellcolor{green!12}0,000000 & \cellcolor{green!12}6,000000 \\
$R_{2}$ & \cellcolor{blue!12}1,000000 & 4,000000 & 0,000000 & 1,000000 & 12,000000 \\
\bottomrule
\end{tabular}
\\[4pt]\textbf{Fracciones } $b_i/a_{i,j}$ para la columna $x_{1}$:\\
$R_{1} = 6,000000$ \;\;\textbf{(m\'inima)},\ $R_{2} = 12,000000$.
\end{table}
...
\toprule
 & $x_{1}$ & $x_{2}$ & $s_{1}$ & $s_{2}$ & $b$ \\
\midrule
$Z$ & 0,000000 & -2,000000 & -1,000000 & 0,000000 & -6,000000 \\
$R_{1}$ & 1,000000 & 1,000000 & 1,000000 & 0,000000 & 6,000000 \\
$R_{2}$ & 0,000000 & 3,000000 & -1,000000 & 1,000000 & 6,000000 \\
\bottomrule
\end{tabular}
\end{table}
