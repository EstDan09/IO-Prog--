...
Se detect\'o una variable no b\'asica con costo reducido cero: $x_{2}$. Esto implica la existencia de un conjunto infinito de soluciones \'{o}ptimas.\\[4pt]
Una parametrizaci\'on de la arista \'optima es:\\[4pt]
\[ $x_{2}$ = t,\quad x_{B_i} = b_i - a_{i,2}\,t,\quad 0 \le t \le \theta \]
Tomando $\theta = 1.000000$ de las fracciones v\'alidas.\\[8pt]
Punto 1: $t = 0.250000$ \;\Rightarrow\; $x_{1} = 0.750000$,\ $x_{2} = 0.250000$.\\[4pt]
Punto 2: $t = 0.500000$ \;\Rightarrow\; $x_{1} = 0.500000$,\ $x_{2} = 0.500000$.\\[4pt]
Punto 3: $t = 0.750000$ \;\Rightarrow\; $x_{1} = 0.250000$,\ $x_{2} = 0.750000$.\\[4pt]
...
Soluci\'on alterna b\'asica: $x_{1}=0.000000$,\ $x_{2}=1.000000$;\quad Z = 1.000000.\\[4pt]
