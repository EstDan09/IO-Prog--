...
\toprule
Base & $x_{1}$ & $x_{2}$ & $x_{3}$ & $y_{1}$ & $y_{2}$ & $y_{3}$ & $y_{4}$ & $y_{5}$ & $y_{6}$ & $b$ \\
\midrule
...
\begin{table}[h]
\centering
\caption{Iteraci\'on 4: entra la columna $y_{3}$ y sale la fila $R_{1}$.}
\setlength{\tabcolsep}{6pt}
\renewcommand{\arraystretch}{1.15}
\begin{tabular}{lrrrrrrrrrr}
\toprule
...
\bottomrule
\end{tabular}
\\[4pt]\textbf{Fracciones } $b_i/a_{i,j}$ para la columna $y_{3}$:\\
