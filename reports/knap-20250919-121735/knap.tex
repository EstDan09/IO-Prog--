...
El conjunto de datos incluye 3 objetos disponibles, cada uno caracterizado por un peso y un valor asociado. \\ 
...
Maximizar $Z = \sum_{i=1}^{3} v_i x_i$ \quad sujeto a $\sum_{i=1}^{3} w_i x_i \le 5$, $x_i \ge 0$ enteras, $0\le x_i \le q_i$.
\\Datos:\\\
...
1 & \textcolor{green!70!black}{0} & \textcolor{green!70!black}{0} & \textcolor{red!70!black}{1} & \textcolor{red!70!black}{1} & \textcolor{red!70!black}{2} & \textcolor{red!70!black}{2} \\
2 & \textcolor{green!70!black}{0} & \textcolor{green!70!black}{0} & \textcolor{green!70!black}{1} & \textcolor{green!70!black}{1} & \textcolor{green!70!black}{2} & \textcolor{green!70!black}{2} \\
3 & \textcolor{green!70!black}{0} & \textcolor{green!70!black}{0} & \textcolor{green!70!black}{1} & \textcolor{green!70!black}{1} & \textcolor{green!70!black}{2} & \textcolor{red!70!black}{3} \\
\hline\end{tabular}
\end{center}
